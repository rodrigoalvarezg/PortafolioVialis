 ...
 * @author Esteban
 */
public class Mensajes_UsuarioNoEncontrado extends javax.swing.JFrame {
    ...
    int xMouse;
    int yMouse;
    public Mensajes_UsuarioNoEncontrado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/NOMBRENOENCONTRADO.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensajes_UsuarioNoEncontrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mensajes_UsuarioNoEncontrado().setVisible(true);
            }
        });
    }
